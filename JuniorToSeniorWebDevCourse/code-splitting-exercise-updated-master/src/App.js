...
// Part 4 - React.lazy - lazy loading components
...
class App extends Component {
  ...
  render() {
    ...
    if (this.state.route === 'page1') {
      ...
      return (
        // Lazy loaded components need to be wrapped in a Suspense component.
        // the Suspense takes a fallback component which will render while 
        // waiting for the lazy loaded component to render  
